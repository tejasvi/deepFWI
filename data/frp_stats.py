...
# gfas_frp.ipynb notebook. Calculated without applying mask or transformation
...
# Statistics of FRP calculated on 12 month of data demonstrated in the
# gfas_frp.ipynb notebook. Calculated after applying boxcox transform on the
# pre-transform data
...
# Pre-transform stats of gfas_frp.ipynb
